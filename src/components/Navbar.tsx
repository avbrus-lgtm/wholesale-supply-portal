      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 flex items-center justify-between h-16 md:h-20">
        <button onClick={() => onScrollTo("home")} className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-lg bg-black flex items-center justify-center">
            <img src="https://cdn.poehali.dev/projects/64573d10-61c4-42bd-9171-9b2052c78b55/bucket/92dfc863-0bd7-4784-ad83-08f8f2015244.png" alt="Полиград" className="h-8 w-8 object-contain" />
          </div>
